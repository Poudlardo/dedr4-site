...
function clickHamberger() {
  ...
  return (
    <nav className='wh-navbar'>
        ...
        <img className="wh-dedra-logo" src="images/unnamed-trnsprntwhite.png" /> DEDRA 
        </Link>
        <div id="wh-wrapper">
          <ul>
          ...
          <li className="wh-different">
          <Link className='wh-nav-link' to="/connect" onClick={closeMobileMenu}>
              CONNECT
          </Link>
          </li>
          </ul>
        ...
        <svg viewBox="0 0 100 80" width="40" height="30" className='wh-hbrgerLogo' onClick={clickHamberger}>
