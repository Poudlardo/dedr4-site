...
function Termsofservice() { 
    ...
    return (
        <div className="tos-page">
            ...
            <br />
            <p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you" and Dedra ("Company", "we", "us", or "our"), concerning your access to and use of the https://dedragames.com/ website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
            ...
            <br />
            <p>Unless otherwise indicated, the Site is our proprietary property and all source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics on the Site (collectively, the "Content") and the trademarks, service marks, and logos contained therein (the "Marks") are owned or controlled by us or licensed to us, and are protected by copyright and trademark laws and various other intellectual property rights and unfair competition laws of the European Union, foreign jurisdictions, and international conventions. The Content and the Marks are provided on the Site "AS IS" for your information and personal use only. Except as expressly provided in these Terms of Use, no part of the Site and no Content or Marks may be copied, reproduced, aggregated, republished, uploaded, posted, publicly displayed, encoded, translated, transmitted, distributed, sold, licensed, or otherwise exploited for any commercial purpose whatsoever, without our express prior written permission.
            ...
            8. Upload or transmit (or attempt to upload or to transmit) any material that acts as a passive or active information collection or transmission mechanism, including without limitation, clear graphics interchange formats ("gifs"),pixels, web bugs, cookies, or other similar devices (sometimes referred to as "spyware" or "assive collection mechanisms"or "pcms").
            ...
            16. Use any information obtained from the Site in order to harass, abuse, or harm another person.
            ...
            23. Disparage, tarnish, or otherwise harm, in our opinion, us and/or the Site. </p>
            <br />
            <h3>SOCIAL MEDIA</h3>
            <br />
            <p>  </p>
            ...
            <p>We care about data privacy and security. Please review our Privacy Policy: http://dedragames.com/#/agreement. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Use. Please be advised the Site is hosted in the European Union. If you access the Site from America, Asia, or any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the European Union, then through your continued use of the Site, you are transferring your data to the European Union, and you expressly consent to have your data transferred to and processed in the European Union.</p>
            <br />
            ...
            <h3>GOVERNING LAW</h3>
            <br />
            <p>These Terms of Use and your use of the Site are governed by and construed in accordance with the laws of France applicable to agreements made and to be entirely performed within France, without regard to its conflict of law principles.</p>
            <br />
            <h3>DISPUTE RESOLUTION</h3>
            <br />
            <p>Any legal action of whatever nature brought by either you or us (collectively, the "Parties" and individually, a "Party") shall be commenced or prosecuted in the state and federal courts located in France and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms of Use. In no event shall any claim, action, or proceeding brought by either Party related in any way to the Site be commenced more than one (1) years after the cause of action arose.</p>
            <br />
            <h3>CORRECTIONS</h3>
            <br />
