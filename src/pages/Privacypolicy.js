  ...
  return (
    <div className="Privacypage">
      ...
      <p id="faq-intro">
        ...
        <a href="http://dedragames.com">dedragames.com/</a> ("Company", "we",
        ...
        personal information, please contact us at <b>contact@dedragames.com</b>
        .<br />
        <br />
        When you visit our website{" "}
        <a href="http://dedragames.com">http://dedragames.com/</a> and use our
        ...
        website (such as{" "}
        <a href="http://dedragames.com">https://dedragames.com/</a>), and/or any
      ...
      <div id="doc-container">
        <nav id="pp-navbar">
          ...
          <a href="#collectinfo" className="pp-nav-link">
            What information do we collect ?
          </a>
          <a href="#useofinfo" className="pp-nav-link">
            How do we use your information?
          </a>
          <a href="#shareinfo" className="pp-nav-link">
            Will your information be shared with anyone?
          </a>
          <a href="#cookies" className="pp-nav-link">
            Do we use cookies and other tracking technologies?
          </a>
          <a href="#sociallogins" className="pp-nav-link">
            How do we handle your social logins?
          </a>
          <a href="#thirdpartysites" className="pp-nav-link">
            What is ou stance on third-party websites?
          </a>
          <a href="#howlong" className="pp-nav-link">
            How long do we keep your information?
          </a>
          <a href="#safeinformation" className="pp-nav-link">
            How do we keep your information safe?
          </a>
          <a href="#privacyrights" className="pp-nav-link">
            What are your privacy rights?
          </a>
          <a href="#updates" className="pp-nav-link">
            Do we make updates to this policy?
          </a>
          <a href="#contactus" className="pp-nav-link">
            How can you contact us about this policy?
          </a>
        </nav>
        <main id="main-doc">
          <section className="main-section" id="collectinfo">
            ...
            <p>
              ...
              giveaways) or otherwise contacting us. The personal information
              that we collect depends on the context of your interactions with
              us and the Sites, the choices you make and the products and
              features you use. The personal information we collect can include
              the following: Name and Contact Data. We collect your first and
              ...
              and account access. Payment Data. We collect data necessary to
              ...
              your questions. Social Media Login Data. We provide you with the
          ...
          <section className="main-section" id="useofinfo">
            ...
            <p>
              ...
              consent. We use personal information collected via our Sites for a
              ...
              and logon process with your Consent. If you choose to link your
              ...
              YOUR SOCIAL LOGINS " for further information. Fulfill and manage
              your orders for Contractual reasons. We may use your information
              to fulfill and manage your orders, payments, returns, and
              exchanges made through the Sites. Deliver targeted advertising to
              you with your Consent. We may use your information to develop and
              display content and advertising (and work with third parties who
              do so) tailored to your interests and/or location and to measure
              its effectiveness. Request Feedback for our Business Purposes. We
              may use your information to request feedback and to contact you
              about your use of our Sites. To protect our Sites for Legal
              ...
              and prevention). To enforce our terms, conditions and policies for
              Legal Reasons and/or possibly for Contractual. To respond to legal
              requests and prevent harm for Legal Reasons. If we receive a
              subpoena or other legal request, we may need to inspect the data
              we hold to determine how to respond. For other Business Purposes.
          ...
          <section className="main-section" id="shareinfo">
            ...
            <p>
              ...
              following situations: Compliance with Laws. We may disclose your
              ...
              requirements). Vital Interests and Legal Rights. We may disclose
              ...
              in litigation in which we are involved. Vendors, Consultants and
              ...
              third parties to use tracking technology on the Sites, which will
              enable them to collect data about how you interact with the Sites
          ...
          <section className="main-section" id="sociallogins">
            ...
            <p>
              ...
              information about you. Our Sites offer you the ability to register
              ...
              picture as well as other information you choose to make public. We
              will use the information we receive only for the purposes that are
              described in this privacy policy or that are otherwise made clear
              to you on the Sites. Please note that we do not control, and are
          ...
          <section className="main-section" id="thirdpartysites">
            ...
            <p>
              ...
              not affiliated with, our websites. The Sites may contain
              ...
              applications. We cannot guarantee the safety and privacy of data
              you provide to any third parties. Any data collected by third
              parties is not covered by this privacy policy. We are not
          ...
          <section className="main-section" id="safeinformation">
          ...
          <section className="main-section" id="privacyrights">
            ...
            <p>
              ...
              authority. You can find their contact details here. Account
              ...
              similar technologies: Most Web browsers are set to accept cookies
              by default. If you prefer, you can usually choose to set your
              ...
              advertising by advertisers on our Sites visit
              http://www.aboutads.info/choices/. Opting out of email marketing:
              ...
              may note your preferences when you register an account with the
              site.
            </p>
          </section>
          <section className="main-section" id="updates">
          ...
          <section className="main-section" id="contactus">
            <h3>11. HOW CAN YOU CONTACT US ABOUT THIS POLICY?</h3>
            <p>
              If you have questions or comments about this policy, you may email
              us at <b>contact@dedragames.com</b>.
            </p>
          </section>
        </main>
      </div>
