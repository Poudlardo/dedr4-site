    ...
    return (
        <div className="Privacypage">
            <Navbar />
                ...
                <p id='faq-intro'> Thank you for choosing to be part of our community at <a href="http://dedragames.com">dedragames.com/</a> ("Company", "we", "us", or "our"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us at <b>contact@dedragames.com</b>.<br />
<br />
When you visit our website <a href="http://dedragames.com">http://dedragames.com/</a> and use our services, you trust us with your personal information. We take your privacy very seriously. In this privacy notice, we describe our privacy policy. We seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy policy that you do not agree with, please discontinue use of our Sites and our services.
<br /><br />
This privacy policy applies to all information collected through our website (such as <a href="http://dedragames.com">https://dedragames.com/</a>), and/or any related services, sales, marketing or events (we refer to them collectively in this privacy policy as the "Sites").
<br /><br />
            ...
            <a href="#collectinfo" class="pp-nav-link">What information do we collect ?</a>
            <a href="#useofinfo" class="pp-nav-link">How do we use your information?</a>
            <a href="#shareinfo" class="pp-nav-link">Will your information be shared with anyone?</a>
            <a href="#cookies" class="pp-nav-link">Do we use cookies and other tracking technologies?</a>
            <a href="#sociallogins" class="pp-nav-link">How do we handle your social logins?</a>
            <a href="#thirdpartysites" class="pp-nav-link">What is ou stance on third-party websites?</a>
            <a href="#howlong" class="pp-nav-link">How long do we keep your information?</a>
            <a href="#safeinformation" class="pp-nav-link">How do we keep your information safe?</a>
            <a href="#privacyrights" class="pp-nav-link">What are your privacy rights?</a>
            <a href="#updates" class="pp-nav-link">Do we make updates to this policy?</a>
            <a href="#contactus" class="pp-nav-link">How can you contact us about this policy?</a>
            </nav>
            <main id="main-doc">
            <section class="main-section" id="collectinfo">
                <h3 id="header">1. WHAT INFORMATION DO WE COLLECT?</h3>
                <p><b>Personal information you disclose to us</b><br/>
            ...
            <section class="main-section" id="useofinfo">
...
Deliver targeted advertising to you with your Consent. We may use your information to develop and display content and advertising (and work with third parties who do so) tailored to your interests and/or location and to measure its effectiveness.
...
For other Business Purposes. We may use your information for other Business Purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Sites, products, services, marketing and your experience.</p>
            ...
            <section class="main-section" id="shareinfo">
<h3>3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h3>
<p>In Short: We only share information with your consent, to comply with laws, to protect your rights, or to fulfill business obligations.
...
We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Policy.</p>
            ...
            <section class="main-section" id="sociallogins">
<h3>5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h3>
<p>In Short: If you choose to register or log in to our websites using a social media account, we may have access to certain information about you.
...
We will use the information we receive only for the purposes that are described in this privacy policy or that are otherwise made clear to you on the Sites. Please note that we do not control, and are not responsible for, other uses of your personal information by your third party social media provider. We recommend that you review their privacy policy to understand how they collect, use and share your personal information, and how you can set your privacy preferences on their sites and apps.</p>
            ...
            <section class="main-section" id="thirdpartysites">
<h3>6. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h3>
<p>In Short: We are not responsible for the safety of any information that you share with third-party providers who advertise, but are not affiliated with, our websites.
...
The Sites may contain advertisements from third parties that are not affiliated with us and which may link to other websites, online services or mobile applications. We cannot guarantee the safety and privacy of data you provide to any third parties. Any data collected by third parties is not covered by this privacy policy. We are not responsible for the content or privacy and security practices and policies of any third parties, including other websites, services or applications that may be linked to or from the Sites. You should review the policies of such third parties and contact them directly to respond to your questions.</p>
            ...
            <section class="main-section" id="howlong">
<h3>7. HOW LONG DO WE KEEP YOUR INFORMATION?</h3>
<p>In Short: We keep your information for as long as necessary to fulfill the purposes outlined in this privacy policy unless otherwise required by law.
...
When we have no ongoing legitimate business need to process your personal information, we will either delete or anonymize it, or, if this is not possible (for example, because your personal information has been stored in backup archives), then we will securely store your personal information and isolate it from any further processing until deletion is possible.</p>
            ...
            <section class="main-section" id="safeinformation">
...
We have implemented appropriate technical and organizational security measures designed to protect the security of any personal information we process. However, please also remember that we cannot guarantee that the internet itself is 100% secure. Although we will do our best to protect your personal information, transmission of personal information to and from our Sites is at your own risk. You should only access the services within a secure environment.</p>
            ...
            <section class="main-section" id="privacyrights">
...
Opting out of email marketing: You can unsubscribe from our marketing email list at any time by clicking on the unsubscribe link in the emails that we send or by contacting us using the details provided below. You will then be removed from the marketing email list – however, we will still need to send you service-related emails that are necessary for the administration and use of your account. To otherwise opt-out, you may note your preferences when you register an account with the site.</p>
            </section>
...
<p>If you have questions or comments about this policy, you may email us at <b>contact@dedragames.com</b>.</p>
            </section>
            </main>
            </div>
